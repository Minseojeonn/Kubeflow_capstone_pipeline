...
train_imgfloder = ImageFolder('/home/minseo/Kubeflow_capstone_pipeline/custum_trainer/data/train')
train_data_path = [Image.open(i[0]) for i in train_imgfloder.imgs]
train_data_label = [i[1] for i in train_imgfloder.imgs]
train_counters = collections.Counter(label[1] for label in train_imgfloder.imgs)

val_imgfloder = ImageFolder('/home/minseo/Kubeflow_capstone_pipeline/custum_trainer/data/val')
val_data_path = [Image.open(i[0]) for i in val_imgfloder.imgs]
val_data_label = [i[1] for i in val_imgfloder.imgs]
